            ...
            grouped.setdefault(key, []).append(
                {
                    ...
                    "field_1": item.field_1 if item.field_1 is not None else 0,
                    "field_2": item.field_2 if item.field_2 is not None else 0,
                    "field_3": item.field_3 if item.field_3 is not None else 0,
